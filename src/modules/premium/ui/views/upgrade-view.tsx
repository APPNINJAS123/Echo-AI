...
export const UpgradeView=()=>{
    ...
    const{data:subscription}=useSuspenseQuery(trpc.premium.getCurrentSubscription.queryOptions());
    return(
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {products?.map((product)=>{
                    ...
                    return(
                        ...
                        } title={product.name} price={product.prices[0].amountType==="fixed"?product.prices[0].priceAmount/100 :0} description={product.description} priceSuffix={`/${product.prices[0].recurringInterval}`} features={product.benefits.map(
