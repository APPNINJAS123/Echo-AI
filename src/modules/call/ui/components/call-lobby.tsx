...
import { DefaultVideoPlaceholder, StreamVideoParticipant, ToggleAudioPreviewButton, ToggleVideoPreviewButton, useCall, useCallStateHooks, VideoPreview } from '@stream-io/video-react-sdk';
...
const AllowBrowserPermissions=()=>{
    return(
        <p className='text-sm'>
            Please grant your browser permissions to access camera and microphone.
