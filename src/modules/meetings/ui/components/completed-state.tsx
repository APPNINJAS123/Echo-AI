...
import { BookOpenTextIcon, ClockFadingIcon, FileTextIcon, FileVideoIcon, SparklesIcon, VideoIcon } from "lucide-react"
...
"
                ...
                <TabsContent value="recording">
                    <div className="bg-white rounded-lg border px-4 py-5">
                       <video src={data.recordingUrl!} controls className="w-full h-full"></video>
                    </div>
                </TabsContent>
